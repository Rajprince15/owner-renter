    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-slate-100 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          {/* API Error */}
          {apiError && (
            <div className="mb-6 p-4 bg-red-50 border border-red-200 rounded-lg flex items-start" data-testid="signup-error-message">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  <CheckCircle className={`w-5 h-5 mx-auto mb-1 ${formData.user_type === 'renter' ? 'text-blue-600' : 'text-gray-400'}`} />
                  Renter
                </button>
                <button
                  type="button"
                ...
                >
                  <CheckCircle className={`w-5 h-5 mx-auto mb-1 ${formData.user_type === 'owner' ? 'text-blue-600' : 'text-gray-400'}`} />
                  Owner
                </button>
              </div>
            </div>
